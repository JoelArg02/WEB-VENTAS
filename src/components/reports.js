...
document.addEventListener('DOMContentLoaded', function() {
    if (document.getElementById('dateFrom')) {
        ...
        document.getElementById('dateTo').value = formatDateForInput(endOfLastMonth);
...
function changeReportType() {
    ...
    // Mostrar/ocultar filtro de categoría según el tipo de reporte
    const categoryFilter = document.getElementById('categoryFilter');
    if (currentReportType === 'products' || currentReportType === 'inventory') {
...
function renderReport(type, data, filters) {
    ...
    switch (type) {
        case 'sales':
            container.innerHTML = renderSalesReport(data, filters);
            break;
        case 'products':
            container.innerHTML = renderProductsReport(data, filters);
            break;
        case 'inventory':
            container.innerHTML = renderInventoryReport(data, filters);
            break;
        case 'categories':
            container.innerHTML = renderCategoriesReport(data, filters);
            break;
        default:
